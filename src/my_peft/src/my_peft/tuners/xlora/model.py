...
from my_peft.tuners.lora.layer import LoraLayer
from my_peft.tuners.lora.model import LoraModel
from my_peft.tuners.tuners_utils import BaseTuner
...
class XLoraModel(BaseTuner):
    ...
    Example:
        ...
        >>> from my_peft import LoraConfig, PeftModel, get_peft_model, prepare_model_for_int8_training
