...
from my_peft.utils import INCLUDE_LINEAR_LAYERS_SHORTHAND
from my_peft.utils.constants import DUMMY_TARGET_MODULES
from my_peft.utils.peft_types import PeftType
...
class BaseTuner(nn.Module, ABC):
    ...
    The easiest is to check what is done in the `my_peft.tuners.lora.LoraModel` class.
    ...
    def _prepare_adapter_config(self, peft_config: PeftConfig, model_config: dict) -> PeftConfig:
        ...
        Check out `my_peft.tuner.lora.LoraModel._prepare_adapter_config` for an example.
    ...
    def _prepare_model(self, peft_config: PeftConfig, model: nn.Module):
        ...
        See `my_peft.tuner.lora.LoraModel._prepare_model` for an example.
    ...
    def _create_and_replace(
        ...
        Check `my_peft.tuners.lora.LoraModel._create_and_replace` for an example.
    ...
    def _mark_only_adapters_as_trainable(self, model: nn.Module):
        ...
        Check `my_peft.tuners.lora.LoraModel._mark_only_adapters_as_trainable` for an example.
        """
        ...
    ...
    def inject_adapter(self, model: nn.Module, adapter_name: str, autocast_adapter_dtype: bool = True) -> None:
        ...
        hood by `my_peft.mapping.get_peft_model` if a non-prompt tuning adapter class is passed.
