...
from my_peft.tuners.lora.config import LoraRuntimeConfig
...
if is_bnb_available():
    ...
    from my_peft.tuners.ia3 import Linear8bitLt as IA3Linear8bitLt
    from my_peft.tuners.lora import Linear8bitLt as LoraLinear8bitLt

    if is_bnb_4bit_available():
        from my_peft.tuners.ia3 import Linear4bit as IA3Linear4bit
        from my_peft.tuners.lora import Linear4bit as LoraLinear4bit
