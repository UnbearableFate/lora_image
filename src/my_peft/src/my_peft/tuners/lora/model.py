...
from my_peft.import_utils import is_bnb_4bit_available, is_bnb_available
from my_peft.tuners.tuners_utils import (
    BaseTuner,
    BaseTunerLayer,
...
from my_peft.utils.merge_utils import dare_linear, dare_ties, magnitude_prune, task_arithmetic, ties
...
class LoraModel(BaseTuner):
    ...
    Example:
        ...
        >>> from my_peft import LoraModel, LoraConfig
        ...
        >>> import torch
        >>> import transformers
        >>> from my_peft import LoraConfig, PeftModel, get_peft_model, prepare_model_for_kbit_training
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        from my_peft.tuners.adalora import AdaLoraLayer
