...
```py
from my_peft import LoHaConfig, get_peft_model
...
```py
from my_peft import LoKrConfig, get_peft_model
...
```py
from my_peft import AdaLoraConfig, get_peft_model
...
```py
from my_peft import PeftConfig, PeftModel
from transformers import AutoImageProcessor
