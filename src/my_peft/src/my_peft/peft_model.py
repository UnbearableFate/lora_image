...
class PeftModel(PushToHubMixin, torch.nn.Module):
    ...
    **Attributes**:
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            save_embedding_layers (`Union[bool, str]`, *optional*, defaults to `"auto"`):
                ...
                embedding layers `my_peft.utils.other.EMBEDDING_LAYER_NAMES` in config's `target_modules` when available.
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            is_trainable (`bool`, *optional*, defaults to `False`):
                ...
                used for inference.
            config ([`~my_peft.PeftConfig`], *optional*):
    ...
    def get_layer_status(self) -> list[TunerLayerStatus]:
        ...
        Returns:
            list[`my_peft.peft_model.TunerLayerStatus`]:
    ...
    def get_model_status(self) -> TunerModelStatus:
        ...
        Returns:
            `my_peft.peft_model.TunerModelStatus`:
...
class PeftModelForSequenceClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        >>> from my_peft import PeftModelForSequenceClassification, get_peft_config
...
class PeftModelForCausalLM(PeftModel):
    ...
    Example:
        ...
        >>> from my_peft import PeftModelForCausalLM, get_peft_config
...
class PeftModelForSeq2SeqLM(PeftModel):
    ...
    Example:
        ...
        >>> from my_peft import PeftModelForSeq2SeqLM, get_peft_config
...
class PeftModelForTokenClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        ```py
        >>> from transformers import AutoModelForSequenceClassification
        >>> from my_peft import PeftModelForTokenClassification, get_peft_config
...
class PeftModelForQuestionAnswering(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        >>> from my_peft import PeftModelForQuestionAnswering, get_peft_config
...
class PeftModelForFeatureExtraction(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        >>> from my_peft import PeftModelForFeatureExtraction, get_peft_config
