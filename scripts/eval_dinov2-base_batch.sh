#!/usr/bin/env bash
# Batch evaluation for DINOv2-base LoRA runs.
# Iterates first-level subdirectories under MODELS_ROOT as model_path and runs eval.
#
# Usage:
...
#   REQUIRE_ADAPTER=1  # skip folders without adapter_config.json
#
# Extras:
...
MODELS_ROOT="runs/vtab-1k_cifar/dinov2-base/r16"
